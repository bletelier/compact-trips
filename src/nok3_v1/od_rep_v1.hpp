...
#ifndef LBD_OD_REP_V1_HPP
#define LBD_OD_REP_V1_HPP
...
namespace sdsl {
    ...
    public:
        ...
        //Copy constructor
        od_rep_v1(const od_rep_v1& o)
        {
            copy(o);
        }

        //Move constructor
        od_rep_v1(od_rep_v1&& o)
        {
            *this = std::move(o);
        }
        ...
        od_rep_v1(std::vector<std::vector<value_type>> &trips, size_type n){
        ...
        //Assignment Operator
        od_rep_v1& operator=(const od_rep_v1& o)
        {
            if (this != &o) {
                copy(o);
            }
        ...
        od_rep_v1& operator=(od_rep_v1&& o)
        {
            if (this != &o) {
                //Move elements
